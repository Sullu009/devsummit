    ...
    def _loop():
        while True:
            try:
                ...
                logging.getLogger("eventsphere.notification.worker").exception("Consumer crashed, restarting in 5s")
                time.sleep(5)
...
app = FastAPI(title="EventSphere Notification Service", version="1.0.0", lifespan=lifespan)
