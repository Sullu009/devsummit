    ...
    def _loop():
        while True:
            try:
                ...
                logging.getLogger("eventsphere.analytics.worker").exception("Consumer crashed, restarting in 5s")
                time.sleep(5)
...
app = FastAPI(title="EventSphere Analytics Service", version="1.0.0", lifespan=lifespan)
